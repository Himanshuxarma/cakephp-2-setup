    ...
    <div class="col-12">
        <div class="card-body table-responsive p-0">
            ...
            <div class="card card-primary">
                ...
                echo $this->Form->create('User', ['name'=>'editUser', 'novalidate'=>true]); 
...
<?php $this->append('script'); ?>
     ...
     * */
    jQuery("form[name='editUser']").validate({
        ...
        submitHandler: function(form) {
            var data = $("form[name='editUser']").serialize();
            let userId = jQuery('#UserId').val();
            $.post(siteUrl+"/users/edit/"+userId, data, function(response){ 
                if(response){
